...
export default function Dock() {
    ...
    return (
        ...
        >
            <div
                ref={navMenuRef}
                className="flex bg-textPrimary flex-row items-center justify-between md:gap-8 font-NeueMontrealVariable text-card uppercase px-8 py-4 rounded-cardRadius shadow-cardShadow "
            >
