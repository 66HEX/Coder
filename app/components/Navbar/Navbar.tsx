...
export default function Navbar() {
    ...
    return (
        <nav id="nav" className="fixed w-screen h-16 flex justify-between items-center z-30 px-4 bg-hexwhite shadow-xl">
            ...
            <div
                ref={navMenuRef}
                className="flex fixed md:static top-0 left-0 px-4 w-full md:w-auto bg-hexwhite md:bg-transparent flex-col md:flex-row justify-center items-center min-h-svh h-full md:justify-between md:gap-8 font-NeueMontrealVariable font-semibold text-hexblack uppercase"
            >
