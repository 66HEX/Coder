        ...
        >
            <div className="h-full w-full bg-hexblack flex flex-col justify-center items-center overflow-hidden relative rounded-xl">
                <div className="w-full flex flex-col items-start text-hexwhite p-4">
                    <h2 className="hero-web NeueMontrealVariable font-semibold text-fluid uppercase leading-none">web</h2>
                    <div>
                        ...
                        <div className="w-full flex justify-end -mt-2 md:-mt-4 xl:-mt-8">
                            ...
                            <h2 className="hero-designer NeueMontrealVariable font-semibold text-fluid uppercase leading-none ml-4 text-right">designer</h2>
                        </div>
                    </div>
                </div>
                <div
                    className="hero-paragraph absolute bottom-4 xl:bottom-28 right-4 text-hexgray NeueMontrealVariable text-base md:text-2xl">
