        ...
        >
            <div
                ...
                <div className="w-full flex flex-col items-start text-hexblack p-4 z-30">
                    <h2 className="hero-web font-NeueMontrealSemibold text-fluid uppercase leading-none">web</h2>
                    <div>
                        <h2 className="hero-developer font-NeueMontrealSemibold text-fluid uppercase leading-none -mt-2 md:-mt-4 xl:-mt-8">developer</h2>
                        <div className="w-full flex justify-end -mt-2 md:-mt-4 xl:-mt-8">
                            ...
                            <h2 className="hero-designer font-NeueMontrealSemibold text-fluid uppercase leading-none ml-4 text-right">designer</h2>
                        </div>
                    </div>
                </div>
                <div
                    className="hero-paragraph absolute bottom-4 xl:bottom-28 right-4 text-hexgray font-NeueMontrealLight text-base md:text-2xl">
