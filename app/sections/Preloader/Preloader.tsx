    ...
    return (
        ...
        >
            <div
                ...
                <h2 className="preloader-name font-NeueMontrealSemibold text-fluid uppercase leading-none text-left"
                    style={{visibility: 'hidden'}}>
                    marek
                </h2>
                <h2 className="preloader-surname font-NeueMontrealSemibold text-fluid uppercase leading-none text-left"
                    style={{visibility: 'hidden'}}>
                    jóźwiak
                </h2>
            </div>
