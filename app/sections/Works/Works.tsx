        ...
        <section id="works" className="w-screen text-hexblack px-4 pb-4 flex flex-col justify-center items-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                {works.map((work, index) => (
                    work.image ? (
                        <Link href={`/works/${index}`} key={index}> {/* Link na podstawie indeksu dla projektów z obrazkiem */}
                            <div
                                className="relative overflow-hidden rounded-xl shadow-xl h-full"
                                ref={el => {
                        ...
                        <div key={index} className="relative flex justify-center items-center h-full bg-white rounded-xl p-4">
                            <p
